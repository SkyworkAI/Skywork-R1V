...
<font size=7><div align='center' > [[📖Technical Report](https://github.com/SkyworkAI/Skywork-R1V/blob/main/Skywork_R1V.pdf)] [[🤗 Skywork-R1V-38B](https://huggingface.co/Skywork/Skywork-R1V-38B)] [[🤖 ModelScope](https://modelscope.cn/models/Skywork/Skywork-R1V-38B)]</div></font>
...
## 🔥News
**April 1, 2025**: Skywork-R1V supports inference with [[vLLM](https://github.com/vllm-project/vllm)], and the average latency is ~12.3s per 1k tokens in a 4-GPU setup.
